    ...
    public partial class Form2 : Form
    {
        ...
        private void dataGridView1_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            if (dataGridView1.CurrentCell.Value.ToString() == "Delete")
            {
                ...
                if (result == DialogResult.Yes)
                {
                    ...
                    string kapcsolatString3 = "datasource=eu-cdbr-west-02.cleardb.net;port=3306;username=b7a161c4cbea52;password=388ed278;database=heroku_afb9b8b1a529dbe;";
        ...
        private void admin()
        {
            ...
            for(int i = 0;i<users.Count;i++)
            {
                ...
                Numbers_of_public_notes.Clear();
                Numbers_of_shared_notes.Clear();
                ...
                string parancs4 = "SELECT COUNT(`note_id`) FROM `notes`,users WHERE notes.user_id = users.id AND users.email = '" + users[i] + "' AND public = 1;";
                ...
                try
                {
                    ...
                    if (reader4.HasRows)
                    {
                        while (reader4.Read())
                        {
                            Numbers_of_public_notes.Add(Convert.ToInt32(reader4.GetInt32(0)));
                        }
                    }
                    else
                    {
                ...
                class6BindingSource.Add(new Class6() { Username = users[i], Numbers_of_notes = Numbers_of_notes[0], Numbers_of_public_notes = Numbers_of_public_notes[0], Numbers_of_shared_notes = Numbers_of_shared_notes[0] });
            }
        }
