...
namespace note_app2
{
    public partial class Form3 : Form
    {
        ...
        private void regisztracio()
        {
            ...
            else if(empty_rpassword == 1 && empty_passsword+empty_email == 0)
            {
            ...
            {
                error6 = 1;
                LbCheck.Text = "The password have to be atleast six character long!";
                txtpassword2.Text = "";
                txtjelszoujra2.Text = "";
                panel1.BringToFront();
                panel3.BringToFront();
            ...
            {
                error7 = 1;
                LbCheck.Text = "Your email have to contain @!";
                txtemail.Text = "";
                txtpassword2.Text = "";
                txtjelszoujra2.Text = "";
                panel2.BringToFront();
            ...
            else if (txtemail.Text != "" && txtpassword2.Text != "" && txtjelszoujra2.Text != "")
            {
                try
                {
