...
namespace note_app2
{
    public partial class Form6 : Form
    {
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            string parancs2 = "SELECT `password` FROM `users` WHERE `id` = '" + userid+"'";
            ...
            {
                label1.Text = "Your have to be atleast six character long!";
                label1.ForeColor = Color.Red;
                txtpassword.Text = "";
                txtpassword2.Text = "";
                error = 1;
            ...
            {
                string parancs = "UPDATE `users` SET `password` = '" + BCrypt.Net.BCrypt.HashPassword(txtpassword.Text) + "' WHERE `id` = '" + userid + "'";
